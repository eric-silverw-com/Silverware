table 50100 "Autotask Import Journal"
{
    ...
    fields
    {
        ...
        {
            Caption = 'Client No.';
            Description = 'Navision Client No.';
            ...
            begin
                if Customer.Get("Client No.") then begin
                    Customer."Autotask ID" := "Client ID";
                    Customer.Modify();
                end;
            end;
        }
    ...
    keys
    {
        ...
        key(Key1; "Client Name", "Document Date") { }
        key(Key2; "Client No.", "Invoice ID") { }
    }

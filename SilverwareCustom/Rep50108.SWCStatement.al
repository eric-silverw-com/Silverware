report 50108 "SWC Customer Statements"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Silverware Statement.rdl';
        ...
        dataitem(Customer; Customer)
        {
            ...
            dataitem(HeaderFooter; "Integer")
            {
                ...
                dataitem(OpenItem; "Integer")
                {
                    ...
                    column(TempCustLedgEntry_Ext_Doc_No_; TempCustLedgEntry."External Document No.")
                    {
                    }
                ...
                dataitem(CustLedgerEntry4; "Cust. Ledger Entry")
                {
                    ...
                    column(CustLedgerEntry4_Ext_Doc_No_; "External Document No.")
                    {
                    }
